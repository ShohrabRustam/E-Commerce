              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    ...
                    <h4 class="mt-1 mb-5 pb-1"> E-Commerce Website</h4>
                  </div>
  
                  <form method="POST" action="registration">
                    @csrf
                    <div class="form-outline mb-4">
                        <input type="name" name="name" id="form2Example11" class="form-control" placeholder="User Name" required/>
                    ...
                    <div class="form-outline mb-4">
                      <input type="password" name="password" id="form2Example22" placeholder="enter you password " class="form-control"  required/>
